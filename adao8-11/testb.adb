...
procedure test is 
    ...
    procedure Read (Item      :    out Image_Type;
        ...
        Pix_Length : Integer := 2;
        Form_Length : Integer;
        File_Format : String(1..3);
        S : String(1..Item.X_Dim);

    begin

        File_Format := Get_Line(File_Item, Form_Length);
...
begin
    ...
    --      Read(Image, Input_File);
    --  end loop;
    --  Close_File(Input_File);
    --  if check_Arg then
    --      Put("This is supposed to be the terminal output");
